...
Group:          kernel
Source0:        https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.18.2.tar.xz
Source1:        config
Source2:        cmdline
...
createCPIO() {
    ...
    cp %{buildroot}${ModDir}/kernel/drivers/input/vivaldi-fmap.ko     cpiofile${ModDir}/kernel/drivers/input
